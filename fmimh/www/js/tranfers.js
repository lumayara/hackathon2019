...
var mosp = {
    ...
    tableFilters        : {
        count       : true,
        userid      : JSON.parse(localStorage.getItem(CONSTANS.USER))._id
    },
    ...
    cbTable: function() {
        ...
        plGlobals.backEnd("POST", "/admin/tranfers/list", mosp.tableFilters,
            function(response) {
                ...
                $.each(response.data, function(index, file){
                    ...
                    col[1] = { data: file.phone};
                    col[2] = { data: file.value };
